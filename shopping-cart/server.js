...
const PRODUCT_DATA_FILE = path.join(__dirname, './src/json/server-product-data.json');
const CART_DATA_FILE = path.join(__dirname, './src/json/server-cart-data.json');
...
// must learn about setHeader string
